...
#define FILENAME_W "lax_friedrichs_w.dat"   /* Nom du fichier ou on
                                           ecrit la solution */
#define FILENAME_V "lax_friedrichs_v.dat"   /* Nom du fichier ou on
                                           ecrit la solution pour la vitesse*/
...
int main(void){
	...
	*/
	...
	for(n=1;n<nt;n++){
		godunov(nr, k/h, M, l_border, r_border, r_dis, uold, unew);
		for(j=0;j<nr;j++){
